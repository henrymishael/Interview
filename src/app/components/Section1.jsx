...
export const Section1 = () => {
  return (
    <>
    <div className='flex lg:flex-row xsm:flex-col md:justify-center md:items-center lg:min-h-[80vh] xsm:min-h-[40rem]  xsm:px-12 xsm:mt-52 lg:mt-32  lg:px-20 xsm:gap-16 lg:gap-0  xsm:w-[150%] lg:w-[100%] '>
