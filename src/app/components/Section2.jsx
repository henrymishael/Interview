...
function Section2() {
  return (
    <div className='section2 flex lg:flex-row xsm:flex-col md:items-center md:justify-center  xsm:gap-16 lg:gap-0 xsm:min-h-[40rem] lg:min-h-[70vh]  lg:w-[100%] xsm:w-[150%] lg:mt-16 xsm:mt-44 xsm:px-12 lg:px-20'> 
