...
function Section2() {
  return (
    <div className='section2 flex lg:flex-row xsm:flex-col md:items-center md:justify-center  xsm:gap-16 lg:gap-0 xsm:min-h-[40rem] lg:min-h-[36rem]  lg:w-[100%] xsm:w-[150%] lg:mt-16 xsm:mt-44 xsm:px-12 lg:px-20'> 
      ...
      <div className='lg:w-[55rem]  flex flex-col gap-1 xsm:text-center lg:text-left lg:pl-32'>
        ...
        <div className='flex flex-row gap-6 mt-10 text-[#0d6efd] font-semibold xsm:justify-center lg:justify-normal '>
            <button className='px-6 py-2.5 rounded-md border-[#0d6efd] border-[1px]'>Get Started</button>
