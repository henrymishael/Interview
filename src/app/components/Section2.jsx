...
function Section2() {
  return (
    <div className='section2 flex md:flex-row xsm:flex-col items-center justify-center gap-16 min-h-[700px]  md:w-[100%] xsm:w-[150%] md:mt-12 xsm:mt-44 xsm:px-12 md:px-0'> 
      <div>
        <Image src={map} />
      </div>
      <div className='md:w-[30%] xsm:w-[100%]  flex flex-col gap-4 xsm:text-center md:text-left'>
