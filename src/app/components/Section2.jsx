...
function Section2() {
  return (
    <div className='section2 flex lg:flex-row xsm:flex-col items-center justify-center gap-16 min-h-[700px]  md:w-[100%] xsm:w-[150%] lg:mt-8 xsm:mt-44 xsm:px-12 lg:px-0'> 
      <div>
        <Image src={map} />
      </div>
