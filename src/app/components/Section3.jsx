...
export const Section3 = () => {
  return (
    <div className='flex lg:flex-row xsm:flex-col items-center justify-center gap-16 lg:min-h-[400px] xsm:min-h-[700px]  md:w-[100%] xsm:w-[150%] lg:mt-4 xsm:mt-44 xsm:px-12 lg:px-0'>
