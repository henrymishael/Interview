...
export const Section3 = () => {
  return (
    <div className='flex lg:flex-row xsm:flex-col items-center justify-center gap-16 xsm:min-h-[40rem] lg:min-h-[36rem]  lg:w-[100%] xsm:w-[150%]  xsm:mt-44 lg:mt-0 xsm:px-12 lg:px-20 '>
