...
export const Section4 = () => {
  return (
    <div className='flex lg:flex-row xsm:flex-col items-center justify-center gap-16 xsm:min-h-[700px] lg:min-h-[450px]  lg:w-[100%] xsm:w-[150%] lg:mt-16 xsm:mt-44 xsm:px-12 lg:px-12'> 
      <div className='lg:w-[1000px]'>
        <Image src={bg} />
      </div>
      <div className='lg:w-[900px] flex flex-col gap-1 xsm:text-center lg:text-left '>
