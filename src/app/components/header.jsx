...
export const Header = () => {
  ...
  return (
    <header className=' flex flex-row  xsm:justify-between xsm:px-10 lg:px-20  h-[80px] items-center   fixed left-0 right-0 top-0 shadow-md bg-white z-[999] max-w-[1500px] '>
